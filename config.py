...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6909070564:AAFepxvjCQR_2j826lZoPSK82Bu6JA4uuqM")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "URLUploader778bot") # Bot username without @.
