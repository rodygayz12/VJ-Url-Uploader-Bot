...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6861294909:AAEf5aupZPVgBeWmfM864AWcLSoRyutDrnY")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "Storagedrive6bot") # Bot username without @.
